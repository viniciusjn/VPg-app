...
export const GameCard = ({ id, name, background_image, rating, platforms, genres }: GameCardProps) => (
  <div className='group relative min-h-[12vh] rounded bg-zinc-900 md:min-h-[12vw] '>
    ...
    <div className='invisible absolute top-0 z-50 w-full min-w-[20vw] scale-0 opacity-0 transition delay-300 duration-200 group-hover:-translate-y-[6vw] group-hover:scale-110 group-hover:opacity-100 sm:visible'>
      <Image
        src={background_image} 
        alt={name}
        width={600}
